...
const highlights = [
  {
    title: "AI Systems Researcher (ARMS Lab @ UC Davis)",
    body: "Built C# REST APIs and n8n + LLM pipelines to process natural-language CAD inputs, orchestrate RAG/SQL retrieval, and drive geometry workflows via SolidWorks.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
      ...
      <section className="section">
        <div className="container">
          ...
          <div className="hero-meta">
            <span className="chip">Expected Graduation: June 2027</span>
